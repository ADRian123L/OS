...
The decompress.c file is for decompressing the file called 'video.vzip' which is created by compress.c file.

To run it, you need to create a folder, compile the c code and run it.

    Here is an example:
    
        mkdir decompressor_images

        gcc -o decompress decompress.c -lz

        ./decompress decompressor_images
